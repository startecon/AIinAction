...
import AjastusAdd from "./AjastusAdd";
import AjastusEdit from "./AjastusEdit";
import AjastusPreview from "./AjastusPreview";
...
/* Luokka */
export class Ajastus extends React.Component {
                ...
                authFetch(this.props.pca, API_PREFIX + '/Read')
                    ...
                    .then(data => {
                        ...
                        authFetch(this.props.pca, PROFIILI_GET)
                            .then(response => response.json())
                            .then(data => {
                                var cols = (((JSON.parse(data.uI_Settings) || {}).columns || {}).ajastus || []); //TODO muuta avain
    ...
    swapCols = (index) => {
        if (index > 1) {
            ...
            var setting = { "key": "columns.ajastus", "value": JSON.stringify(cols.map(function (d) { return d.name; })).split('"').join('""') }; //TODO muuta avain
        ...
        var options = {
           ...
           responsive: "standard",
            ...
            customToolbarSelect: (selectedRows, displayData, setSelectedRows) => {
                ...
                return (
                    <div className={"custom-toolbar-select"}>
                        <AjastusPreview Daatta={this.state.data} lookupLists={this.state.lookupLists} rowId={rowId} />
                        <AjastusEdit onEditRow={this.editItem} lookupLists={this.state.lookupLists} onLookupListChange={this.addNewLookupItem} Daatta={this.state.data} rowId={rowId} />
            ...
            customToolbar: () => {
                return (
                    <React.Fragment>
                        <AjastusAdd onAddNewRow={this.addNewItem} lookupLists={this.state.lookupLists} onLookupListChange={this.addNewLookupItem} />
                ...
                <div>
                    {(this.state.loading) ? (
                        <CircularProgress />
                            ...
                            <MUIDataTable
                                title={dictionary.Ajastus.Title}
