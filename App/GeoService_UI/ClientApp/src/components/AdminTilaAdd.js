...
class AdminTilaAdd extends React.Component {
    ...
    handleSave = () => {
        this.props.onAddNewRow({
            TilaAvain: 1, //this.state.TilaAvain,
...
export default withStyles(defaultToolbarStyles, { name: "AdminTilaAdd" })(AdminTilaAdd);
