...
import KoodiryhmaAdd from "./KoodiryhmaAdd";
import KoodiryhmaEdit from "./KoodiryhmaEdit";
import KoodiryhmaPreview from "./KoodiryhmaPreview";
...
const API_PREFIX = 'api/Koodiryhma';
...
/* Luokka */
export class Koodiryhma extends Component {
        ...
        authFetch(this.props.pca, API_PREFIX + '/Read')
            ...
            .then(data => {
                ...
                authFetch(this.props.pca, PROFIILI_GET)
                    ...
                    .then(data => {
                        console.log(data);
                        var cols = (((JSON.parse(data.uI_Settings) || {}).columns || {}).koodiryhma || []);
    ...
    swapCols = (index) => {
        if (index > 1) {
            ...
            var setting = { "key": "columns.koodiryhma", "value": JSON.stringify(cols.map(function (d) { return d.name; })).split('"').join('""') };
        ...
        var options = {
           ...
           responsive: "standard",
            ...
            customToolbarSelect: (selectedRows, displayData, setSelectedRows) => {
                ...
                return (
                    <div className={"custom-toolbar-select"}>
                        <KoodiryhmaPreview Daatta={this.state.data} rowId={rowId} />
                        <KoodiryhmaEdit onEditRow={this.editItem} Daatta={this.state.data} rowId={rowId} />
            ...
            customToolbar: () => {
                return (
                    <React.Fragment>
                        <KoodiryhmaAdd onAddNewRow={this.addNewItem} />
                ...
                <div>
                    {(this.state.loading) ? (
                        <CircularProgress />
                            ...
                            <MUIDataTable
                                title={dictionary.Koodiryhma.Title}
