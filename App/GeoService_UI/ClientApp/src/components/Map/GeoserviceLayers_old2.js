...
import { LeafletContext, createControlComponent } from '@react-leaflet/core';
...
class GeoserviceLayersControl extends Component {
    constructor(props) {
        super(props);
        this.controlProps = {
...
class CustomLayersControl extends Component {
...
L.Control.GeoserviceLayers = L.Control.extend({
    onAdd: function (map) {
        const container = L.DomUtil.create("div");


        return ReactDOM.createPortal(CustomLayersControl, container);
    },

    onRemove: function (map) { },
});

export const GeoserviceLayers = createControlComponent(
    (props) => new L.Control.GeoserviceLayers(props),
)

//export default withLeaflet(GeoserviceLayers);
