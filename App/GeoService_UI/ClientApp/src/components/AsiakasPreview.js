...
class AsiakasPreview extends React.Component {
        ...
        return (
            <React.Fragment>
                ...
                <Dialog open={this.state.open} onClose={handleClose} aria-labelledby="form-dialog-title">
                    <DialogTitle id="form-dialog-title">Asiakas</DialogTitle>
                    <DialogContent style={{ width: "450px" }}>
                        <div>
                            <InputLabel>Asiakasavain</InputLabel>
                            <p className="teksti" >{this.state.RiviAvain}</p>
                            <br />
                            <InputLabel>Asiakas</InputLabel>
                            <p className="teksti" >{this.state.AsiakasNimi}</p>
                            <br />
                            <InputLabel>Azure Tenant</InputLabel>
                            <p className="teksti" >{this.state.TenantId}</p>
                            <br />
...
export default withStyles(defaultToolbarStyles, { name: "AsiakasPreview" })(AsiakasPreview);
