...
class CarbonAdd extends React.Component {
        ...
        return (
            <React.Fragment>
                ...
                <Dialog open={this.state.open} onClose={handleClose} maxWidth={false} aria-labelledby="form-dialog-title">
                    <DialogTitle id="form-dialog-title">{dictionary.Carbon.Title}</DialogTitle>
...
export default withStyles(defaultToolbarStyles, { name: "CarbonAdd" })(CarbonAdd);
