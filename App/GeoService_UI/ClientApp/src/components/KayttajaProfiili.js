...
export default class KayttajaProfiili extends Component {
        ...
        return (
            <div>
                <ListItemButton sx={{ pl: 4 }} onClick={() => this.setState({ open: true })}>
                    <ListItemIcon><Person2Icon fontSize="medium" color="iconText" style={{ fontSize: "25pt" }} /></ListItemIcon>
                    <ListItemText primary="Käyttäjän profiili" color="iconText" />
                </ListItemButton>
                        ...
                        <Grid container alignItems="center">
                            <Grid item lg={6} style={{ paddingRight: "10px" }}>
                                <TextField
                                    ...
                                    color="iconText"
                                    variant="outlined"
                                    defaultValue={this.state.Etunimi}
                                    fullWidth
                                />
                            </Grid>
                            <Grid item lg={6}>
                                <TextField
                                    ...
                                    color="iconText"
                                    variant="outlined"
                                    defaultValue={this.state.Sukunimi}
                                    fullWidth
                                />
                            </Grid>
                        </Grid>
