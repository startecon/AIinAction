...
// MongoDB-yhteys
const CONNECTION_STRING = "mongodb+srv://aiinaction:Klondyke1234@starteconcluster1.cg9gxnb.mongodb.net/?retryWrites=true&w=majority&appName=StarteconCluster1";
const client = new MongoClient(CONNECTION_STRING);
const dbName = "EcoWind";
const collName = "observations_wind_power_vectors_3"; // Rev. 3
...
functions.http('helloHttp', (req, res) => {
    ...
    if (req.method === 'OPTIONS') {
        ...
        //Format response
        const data = await result.forEach((doc) => {
